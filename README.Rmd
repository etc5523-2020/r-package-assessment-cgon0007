...
![chenjie say hi :P](http://img.shields.io/badge/do%20i%20rock-passing-ff69bd.svg)
<!-- badges: end -->

The goal of covid package is to provid the covid-19 data and function for the people to explore.
and it contain a coronavirus dateset, which have 2000960 observations and 9 variables.
...
.
```{r , echo = FALSE, out.width='50%'}
knitr::include_graphics("shinycut.png")
```
.
...
# REFERENCE
## citation
h2("shiny,coronavirus,tidyverse,plotly,ggplot2")
             h4("
